...
def parse_option():
    ...
    parser.add_argument('--model_path', type=str, default='./save_cls_YLSTM_256_contra', help='path to save model')
    parser.add_argument('--save', type=str, default='./save_cls_YLSTM_256_contra', help='path to save linear classifier')
