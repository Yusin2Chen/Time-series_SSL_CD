...
def parse_option():
    ...
    # output
    parser.add_argument('--out_dir', type=str, default='./result_contra+crw_pos_nomask_adjcent50', help='path to save linear classifier')
    parser.add_argument('--score', action='store_true', default=True, help='score prediction results using ground-truth data')
    parser.add_argument('--preview_dir', type=str, default='./preview_contra+crw_pos_nomask_adjcent50_RGB', help='path to preview dir (default: no previews)')
