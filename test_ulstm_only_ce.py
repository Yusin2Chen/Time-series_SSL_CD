...
def parse_option():
    ...
    # output
    parser.add_argument('--out_dir', type=str, default='./result_only_ce', help='path to save linear classifier')
    parser.add_argument('--score', action='store_true', default=True, help='score prediction results using ground-truth data')
    parser.add_argument('--preview_dir', type=str, default='./preview_only_ce', help='path to preview dir (default: no previews)')
...
def lstm_factory(model):
    ...
    pretrained_model = os.path.join('./save_cls_YLSTM_256_ce/ResUnet182/BOYL_epoch_199_0.17846293581297268.pth')
