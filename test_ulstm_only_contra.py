...
def parse_option():
    ...
    # output
    parser.add_argument('--out_dir', type=str, default='./result_only_contra', help='path to save linear classifier')
    parser.add_argument('--score', action='store_true', default=True, help='score prediction results using ground-truth data')
    parser.add_argument('--preview_dir', type=str, default='./preview_only_contra_RGB', help='path to preview dir (default: no previews)')
...
def lstm_factory(model):
    ...
    pretrained_model = os.path.join('./save_cls_YLSTM_256_mlp_contra/ResUnet182/BOYL_epoch_9_0.4487574007865545.pth')
